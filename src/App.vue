...
const BirthCalendar = defineAsyncComponent(() => import('./components/Birth/BirthCalendar.vue'))
...
<template>
  <div class="app min-h-screen flex flex-col bg-theme-primary overflow-x-hidden">
    ...
    <template v-else>
      ...
      >
        <span aria-hidden="true" class="group-hover:rotate-90 transition-transform duration-300"
          >+</span
        >
      </button>
