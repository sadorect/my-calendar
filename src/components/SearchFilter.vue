<template>
  <div class="bg-theme-card border-b border-theme px-4 py-3">
    <div class="flex flex-col sm:flex-row gap-3">
      ...
      <div class="flex-1">
        <div class="relative">
          ...
          <input
            ...
            class="block w-full pl-10 pr-3 py-2 border border-theme rounded-md leading-5 bg-theme-primary placeholder-theme-muted text-theme-primary focus:outline-none focus:placeholder-theme-secondary focus:ring-1 focus:ring-theme-accent focus:border-theme-accent"
          />
        </div>
      </div>
      ...
      <div class="flex gap-2">
        ...
        <select
          ...
          class="px-3 py-2 border border-theme rounded-md bg-theme-primary text-theme-primary focus:outline-none focus:ring-1 focus:ring-theme-accent focus:border-theme-accent"
        >
